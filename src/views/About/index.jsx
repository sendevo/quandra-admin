...
const View = () => (
    <MainView title="Acerca del software">
        ...
        <Accordion sx={styles.accordion}>
                ...
                <AccordionDetails>
                    <Typography><b>{APP_NAME}</b> es una aplicación web que permite consultar el estado de transitabilidad de una ruta, en general, no pavimentada. En el mapa del menú principal, dibuje un trayecto y si es posible obtener datos recientemente registrados en la base de datos del sistema {PROJECT_NAME}, se mostrará el resultado sobre el mismo mapa.</Typography>
            ...
            <Accordion sx={styles.accordion}>
                ...
                <AccordionDetails>
                    ...
                    <ol>
                        <li>Emplear esta aplicación, en cualquiera de sus versiones, únicamente para consultar mediante datos georeferenciados, el estado de transitabilidad de una ruta particular.</li>
